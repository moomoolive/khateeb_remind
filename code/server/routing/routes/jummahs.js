...
router.post(
    ...
    validationMiddleware.validateRequest([
        ...
        validator.body("timingID").isLength(global.CONFIG.consts.mongooseIdLength).isString(),
...
router.put(
    ...
    validationMiddleware.validateRequest([
        validator.body("_id").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
...
router.put(
    ...
    validationMiddleware.validateRequest([
        ...
        validator.body("main.khateebID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        ...
        validator.body("main.institutionID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        validator.body("main.timingID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        validator.body("main.locationID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),

        validator.body("backup._id").isLength({ min: 4 }).isString(),
        validator.body("backup.khateebID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        ...
        validator.body("backup.institutionID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        validator.body("backup.timingID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
        validator.body("backup.locationID").isLength(global.CONFIG.consts.mongooseIdLength).isString().optional(),
    ]),
    authMiddleware.authenticate({ min: 2, max: 3 }),
    async (req, res) => {
        try {
